...
// (https://github.com/kubernetes/kubernetes/issues/57982)
func applyDefaultsWorkaround(containers []corev1.Container, volumes []corev1.Volume, tolerations []corev1.Toleration) {
...
func createPatch(pod *corev1.Pod, sidecarConfig *Config, annotations map[string]string) ([]byte, error) {
        ...
        patch = append(patch, addToleration(pod.Spec.Tolerations, sidecarConfig.Tolerations, "/spec/tolerations")...)
...
func (whsvr *WebhookServer) mutate(ar *v1beta1.AdmissionReview) *v1beta1.AdmissionResponse {
        ...
        applyDefaultsWorkaround(whsvr.sidecarConfig.Containers, whsvr.sidecarConfig.Volumes, whsvr.sidecarConfig.Tolerations)
